...
pub fn run(args: DeliverArgs, g: &Globals) -> Result<Contract, Error> {
    ...
    let (fw, fh) = match args.platform {
        ...
        | DeliverPlatform::Wwe
        | DeliverPlatform::Tsn
        | DeliverPlatform::Sportsnet
        | DeliverPlatform::Beinsports
        | DeliverPlatform::Skysports
        | DeliverPlatform::Tntsports
        | DeliverPlatform::Foxsports
        | DeliverPlatform::Cbssports
        | DeliverPlatform::Eurosport
        | DeliverPlatform::Kayo
        | DeliverPlatform::Optussport
        | DeliverPlatform::Supersport
        | DeliverPlatform::Astro
        | DeliverPlatform::Willow
        | DeliverPlatform::Premier
        | DeliverPlatform::Laliga
        | DeliverPlatform::Bundesliga
        | DeliverPlatform::Seriea
        | DeliverPlatform::Ligue1
        | DeliverPlatform::Mls
        ...
        | DeliverPlatform::Airmeet
        | DeliverPlatform::Shutterstock
        | DeliverPlatform::Pond5
        | DeliverPlatform::Artgrid
        ...
        | DeliverPlatform::Copart
        | DeliverPlatform::Airbnb
        | DeliverPlatform::Booking
        | DeliverPlatform::Expedia
        ...
        | DeliverPlatform::Nascar
        | DeliverPlatform::Orange
        | DeliverPlatform::Sfr
        | DeliverPlatform::Free
        | DeliverPlatform::Proximus
        | DeliverPlatform::Swisscom
        | DeliverPlatform::Telstra
        | DeliverPlatform::Kpn
        | DeliverPlatform::Appstore
        | DeliverPlatform::Googleplay
        | DeliverPlatform::Testflight
        | DeliverPlatform::Apkpure
        ...
        | DeliverPlatform::Omny
        | DeliverPlatform::Googleclassroom
        | DeliverPlatform::Moodle
        | DeliverPlatform::Blackboard
...
fn platform_name(p: DeliverPlatform) -> &'static str {
    match p {
        ...
        DeliverPlatform::Orange => "orange",
        DeliverPlatform::Sfr => "sfr",
        DeliverPlatform::Free => "free",
        DeliverPlatform::Proximus => "proximus",
        DeliverPlatform::Swisscom => "swisscom",
        DeliverPlatform::Telstra => "telstra",
        DeliverPlatform::Kpn => "kpn",
        DeliverPlatform::Appstore => "appstore",
        DeliverPlatform::Googleplay => "googleplay",
        DeliverPlatform::Testflight => "testflight",
        DeliverPlatform::Apkpure => "apkpure",
        ...
        DeliverPlatform::Googleclassroom => "googleclassroom",
        DeliverPlatform::Moodle => "moodle",
        DeliverPlatform::Blackboard => "blackboard",
        DeliverPlatform::Canvaslms => "canvaslms",
        ...
        DeliverPlatform::Tsn => "tsn",
        DeliverPlatform::Sportsnet => "sportsnet",
        DeliverPlatform::Beinsports => "beinsports",
        DeliverPlatform::Skysports => "skysports",
        DeliverPlatform::Tntsports => "tntsports",
        DeliverPlatform::Foxsports => "foxsports",
        DeliverPlatform::Cbssports => "cbssports",
        DeliverPlatform::Eurosport => "eurosport",
        DeliverPlatform::Kayo => "kayo",
        DeliverPlatform::Optussport => "optussport",
        DeliverPlatform::Supersport => "supersport",
        DeliverPlatform::Astro => "astro",
        DeliverPlatform::Willow => "willow",
        DeliverPlatform::Premier => "premier",
        DeliverPlatform::Laliga => "laliga",
        DeliverPlatform::Bundesliga => "bundesliga",
        DeliverPlatform::Seriea => "seriea",
        DeliverPlatform::Ligue1 => "ligue1",
        ...
        DeliverPlatform::Shutterstock => "shutterstock",
        DeliverPlatform::Pond5 => "pond5",
        DeliverPlatform::Artgrid => "artgrid",
        DeliverPlatform::Storyblocks => "storyblocks",
        ...
        DeliverPlatform::Airbnb => "airbnb",
        DeliverPlatform::Booking => "booking",
        DeliverPlatform::Expedia => "expedia",
        DeliverPlatform::Hotels => "hotels",
