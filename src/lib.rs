...
pub fn run(cli: Cli) -> Result<Contract, Error> {
    ...
    match cli.cmd {
        ...
        Cmd::Interp(args) => verbs::interp::run(args, &g),
        Cmd::Matrix(args) => verbs::matrix::run(args, &g),
        Cmd::Legalize(args) => verbs::legalize::run(args, &g),
        Cmd::Levels(args) => verbs::levels::run(args, &g),
        Cmd::Aberrate(args) => verbs::aberrate::run(args, &g),
