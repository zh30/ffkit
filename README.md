...
| `bars` | SMPTE test card: `--size`/`--dur`/`--hd`/`--tone` (1kHz bed), for QC slates and leader | `--kind sd|pal100|pal75|rgb|yuv` other broadcast patterns |
...
| `qa` | Measure quality loss vs a reference: PSNR + SSIM + MSAD (`--metric`) |
