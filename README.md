...
| `blur` | Full-frame or windowed gaussian blur (`--sigma`, `--at`/`--dur` comma list; `--at end` = tail) | `--engine gblur|directional|box` (directional `--angle` streaks; box = fast blocky kernel) |
