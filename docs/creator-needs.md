...
Researched 2026-09-22 against **ffkit 0.42.0** (`main` + round-17 branch). Same-day research base as the 0.26.0/0.27.0 rounds below — refreshed priorities only, no new sources needed. This note is not a restatement of landed work — the tail lists what not to redo.
...
*(round 18: `reverb`, `audiogram --mode/--color`, `delogo --at/--dur`, `meta --rotate`. round 17: `overlay --at/--dur`, `caption --color/--size`, `subs`)*
